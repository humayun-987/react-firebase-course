...
function App() {
  ...
  return (
    <>
      <UserAuth />
      <div>
        <input className='border-2 m-2 rounded-md border-black p-2' type="text" name="movieName" placeholder='Movie name' onChange={handleMovieChange} />
        <input className='border-2 m-2 rounded-md border-black p-2' type="number" name='releasedDate' placeholder='Released date' onChange={handleMovieChange} />
