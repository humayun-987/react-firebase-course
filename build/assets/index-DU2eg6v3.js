 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pl=new Nd("@firebase/auth");function dS(t,...e){pl.logLevel<=ee.WARN&&pl.warn(`Auth (${Gr}): ${t}`,...e)}function Oa(t,...e){pl.logLevel<=ee.ERROR&&pl.error(`Auth (${Gr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr=new Nd("@firebase/firestore");function vs(){return zr.logLevel}function z(t,...e){if(zr.logLevel<=ee.DEBUG){const n=e.map(zd);zr.debug(`Firestore (${Ki}): ${t}`,...n)}}function kn(t,...e){if(zr.logLevel<=ee.ERROR){const n=e.map(zd);zr.error(`Firestore (${Ki}): ${t}`,...n)}}function Mi(t,...e){if(zr.logLevel<=ee.WARN){const n=e.map(zd);zr.warn(`Firestore (${Ki}): ${t}`,...n)}}function zd(t){if(typeof t=="string")return t;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tk=new ve(H.comparator);function Pn(){return tk}const v0=new ve(H.comparator);function Rs(...t){let e=v0;for(const n of t)e=e.insert(n.key,n);return e}function E0(t){let e=v0;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function kr(){return js()}function w0(){return js()}function js(){return new Gi(t=>t.toString(),(t,e)=>t.isEqual(e))}const nk=new ve(H.comparator),rk=new $e(H.comparator);function Z(...t){let e=rk;for(const n of t)e=e.add(n);return e}const ik=new $e(ie);function sk(){return ik}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nf{constructor(e,n,r,i){this.targetId=e,this.fromCache=n,this.Ki=r,this.$i=i}static Ui(e,n){let r=Z(),i=Z();for(const s of n.docChanges)switch(s.type){case 0:r=r.add(s.doc.key);break;case 1:i=i.add(s.doc.key)}return new nf(e,n.fromCache,r,i)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tP{constructor(){this.Wi=!1,this.Gi=!1,this.zi=100,this.ji=function(){return KI()?8:LR(We())>0?6:4}()}initialize(e,n){this.Hi=e,this.indexManager=n,this.Wi=!0}getDocumentsMatchingQuery(e,n,r,i){const s={result:null};return this.Ji(e,n).next(o=>{s.result=o}).next(()=>{if(!s.result)return this.Yi(e,n,i,r).next(o=>{s.result=o})}).next(()=>{if(s.result)return;const o=new eP;return this.Zi(e,n,o).next(l=>{if(s.result=l,this.Gi)return this.Xi(e,n,o,l.size)})}).next(()=>s.result)}Xi(e,n,r,i){return r.documentReadCount<this.zi?(vs()<=ee.DEBUG&&z("QueryEngine","SDK will not create cache indexes for query:",ii(n),"since it only creates cache indexes for collection contains","more than or equal to",this.zi,"documents"),V.resolve()):(vs()<=ee.DEBUG&&z("QueryEngine","Query:",ii(n),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.ji*i?(vs()<=ee.DEBUG&&z("QueryEngine","The SDK decides to create cache indexes for query:",ii(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Zt(n))):V.resolve())}Ji(e,n){if(gg(n))return V.resolve(null);let r=Zt(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=Ah(n,null,"F"),r=Zt(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=Z(...s);return this.Hi.getDocuments(e,o).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const h=this.es(n,l);return this.ts(n,h,o,u.readTime)?this.Ji(e,Ah(n,null,"F")):this.ns(e,h,n,u)}))})))}Yi(e,n,r,i){return gg(n)||i.isEqual(G.min())?V.resolve(null):this.Hi.getDocuments(e,r).next(s=>{const o=this.es(n,s);return this.ts(n,o,r,i)?V.resolve(null):(vs()<=ee.DEBUG&&z("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),ii(n)),this.ns(e,o,n,NR(i,-1)).next(l=>l))})}es(e,n){let r=new $e(_0(e));return n.forEach((i,s)=>{Jl(e,s)&&(r=r.add(s))}),r}ts(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Zi(e,n,r){return vs()<=ee.DEBUG&&z("QueryEngine","Using full collection scan to execute query:",ii(n)),this.Hi.getDocumentsMatchingQuery(e,n,lr.min(),r)}ns(e,n,r,i){return this.Hi.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PE="storage";function FN(t,e,n){return t=ke(t),xN(t,e,n)}function BN(t,e){return t=ke(t),bN(t,e)}function jN(t=Od(),e){t=ke(t);const r=Hl(t,PE).getImmediate({identifier:e}),i=hv("storage");return i&&zN(r,...i),r}function zN(t,e,n,r={}){UN(t,e,n,r)}function $N(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new wf(n,r,i,e,Gr)}function HN(){Fr(new ar(PE,$N,"PUBLIC").setMultipleInstances(!0)),Yt(Kg,Gg,""),Yt(Kg,Gg,"esm2017")}HN();const WN={apiKey:"AIzaSyAT8DGFXa2Y9683kBc_PaTXgvdOsBQOq_w",authDomain:"fir-tutorial-170a0.firebaseapp.com",projectId:"fir-tutorial-170a0",storageBucket:"fir-tutorial-170a0.appspot.com",messagingSenderId:"417483198029",appId:"1:417483198029:web:5c31f34c3971b31e751604",measurementId:"G-4EB1WJX1M7"},Tf=yv(WN),Fe=vR(Tf),qN=new mn,_c=hC(Tf),KN=jN(Tf),GN=()=>{var o,l;const[t,e]=kt.useState({email:"",password:""}),n=u=>{e({...t,[u.target.name]:u.target.value})};console.log((o=Fe==null?void 0:Fe.currentUser)==null?void 0:o.email),console.log((l=Fe==null?void 0:Fe.currentUser)==null?void 0:l.photoURL);const r=async()=>{try{await iA(Fe,t.email,t.password),e({email:"",password:""})}catch(u){console.error(u)}},i=async()=>{try{await PA(Fe,qN)}catch(u){console.error(u)}},s=async()=>{try{await jv(Fe)}catch(u){console.error(u)}};return J.jsxs(J.Fragment,{children:[J.jsxs("div",{className:"flex flex-col",children:[J.jsx("input",{className:"border-2 m-2 rounded-md border-black p-1",type:"text",onChange:n,name:"email",placeholder:"Email..."}),J.jsx("input",{className:"border-2 m-2 rounded-md border-black p-1",type:"text",onChange:n,name:"password",placeholder:"Password..."}),J.jsx("button",{className:"bg-red-500 m-2 p-2 rounded-lg text-white",onClick:r,children:"Sign In"})]}),J.jsx("div",{className:"p-2",children:J.jsx("button",{onClick:i,className:"bg-sky-500 w-full text-lg p-2 rounded-lg text-white",children:"Sign In With Google"})}),J.jsx("div",{className:"p-2",children:J.jsx("button",{onClick:s,className:"bg-black text-lg p-2 w-full rounded-lg text-white",children:"Logout"})})]})};function QN(){var S;const[t,e]=kt.useState([]),[n,r]=kt.useState({movieName:"",releasedDate:null}),[i,s]=kt.useState(!1),[o,l]=kt.useState(""),[u,h]=kt.useState(null),f=uC(_c,"movies");kt.useEffect(()=>{const C=PC(f,L=>{const U=L.docs.map(v=>({...v.data(),id:v.id}));console.log(U),e(U)},L=>{console.error(L)});return()=>C()},[]);const g=async()=>{var C;try{await kC(f,{Name:n.movieName,releasedate:n.releasedDate,recievedAnOscar:i,userId:(C=Fe==null?void 0:Fe.currentUser)==null?void 0:C.uid}),r({movieName:"",releasedDate:null})}catch(L){console.log(L)}},y=C=>{r({...n,[C.target.name]:C.target.value})},A=async C=>{const L=xh(_c,"movies",C);await RC(L)},N=async C=>{const L=xh(_c,"movies",C);await AC(L,{Name:o}),l("")},O=async()=>{if(!u)return;const C=BN(KN,`projectFolder/${u.name}`);try{await FN(C,u)}catch(L){console.error(L)}},[x,I]=kt.useState(null);kt.useEffect(()=>{const C=aA(Fe,L=>{I(L)});return()=>C()},[]);const _=async()=>{try{await jv(Fe)}catch(C){console.error(C)}};return J.jsxs("div",{className:"mx-auto p-2 w-[100%] sm:w-[70%] xl:w-[50%]",children:[J.jsx("div",{className:"w-full mb-2 flex justify-center items-center",children:J.jsx("h1",{className:"font-extrabold mx-auto text-purple-600 text-5xl ",children:"FIREBASE APP"})}),x?J.jsxs("div",{className:"flex gap-5",children:[J.jsx("button",{className:"border-4 border-red-400 bg-yellow-300 text-bold text-lg p-2 m-2 rounded-lg",children:`Logged in as ${(S=Fe==null?void 0:Fe.currentUser)==null?void 0:S.displayName}`}),J.jsx("button",{onClick:_,className:"bg-black text-lg m-2 p-2 rounded-lg text-white",children:"Logout"})]}):J.jsx(GN,{}),J.jsxs("div",{className:"flex flex-col justify-center gap-4",children:[J.jsx("input",{className:"border-2 m-2 rounded-md border-black p-2",type:"text",name:"movieName",value:n.movieName,placeholder:"Movie name",onChange:y}),J.jsx("input",{className:"border-2 m-2 rounded-md border-black p-2",type:"number",name:"releasedDate",value:n.releasedDate||"",placeholder:"Released date",onChange:y}),J.jsxs("div",{children:[J.jsx("input",{type:"checkbox",name:"recievedAnOscar",checked:i,onChange:C=>s(C.target.checked)}),J.jsx("label",{className:"text-lg ml-1",htmlFor:"recievedAnOscar",children:"Recieved an Oscar"})]}),J.jsx("button",{className:"bg-yellow-400 hover:bg-red-600 hover:text-white border-2 rounded-lg border-black text-lg text-black font-bold p-2 m-2",onClick:g,type:"submit",children:"Submit Movie"})]}),J.jsx("div",{className:"m-2 border-4 rounded-xl p-2 border-black",children:t.map(C=>J.jsxs("div",{children:[J.jsx("h1",{className:"text-2xl font-bold",style:{color:C.recievedAnOscar?"green":"red"},children:C.Name}),J.jsx("p",{className:"text-lg text-black",children:C.releasedate}),J.jsx("input",{className:"border-2 border-black p-1 m-1",type:"text",onChange:L=>l(L.target.value),placeholder:"Update Movie Title"}),J.jsx("button",{className:"bg-black text-white p-2 m-1 rounded-lg",onClick:()=>A(C.id),children:"Delete"}),J.jsx("button",{className:"bg-black text-white p-2 m-1 rounded-lg",onClick:()=>N(C.id),children:"Update"})]},C.id))}),J.jsxs("div",{className:"flex gap:20px",children:[J.jsx("input",{className:"border-1 border-yellow-400 bg-yellow-300 p-2 m-2 rounded-lg",type:"file",onChange:C=>h(C.target.files[0])}),J.jsx("button",{className:"rounded-lg border-2 border-black bg-sky-300 p-2 m-2",onClick:O,children:"Upload File"})]})]})}vc.createRoot(document.getElementById("root")).render(J.jsx(Tw.StrictMode,{children:J.jsx(QN,{})}));
